  ...
  <main class="main">
    ...
    <form action="{{ route('todos.store') }}" method="post">
      ...
      <div class="todo--title">
        <input type="text" name="title" placeholder="タイトル" value="{{ old('title') }}" style="border-radius: 4px; border:4px solid antiquewhite;">
      </div>
      ...
      <div class="todo--owner_name">
        <input type="text" name="owner_name" placeholder="担当者名" value="{{ old('owner_name') }}" class="w-1/6" style="border-radius: 4px; border:4px solid antiquewhite;">
      </div>
